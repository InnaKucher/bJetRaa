...
// Tue Feb  4 13:36:35 2020 by ROOT version 6.18/04
// from TTree HiTree/
...
#ifndef hiEvtTreeReaderPbPbMC_h
#define hiEvtTreeReaderPbPbMC_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
 ...
 //pair<float,float> *pdfXpdf;
   ...
   hiEvtTreeReaderPbPbMC(TTree *tree=0);
   virtual ~hiEvtTreeReaderPbPbMC();
...
#ifdef hiEvtTreeReaderPbPbMC_cxx
hiEvtTreeReaderPbPbMC::hiEvtTreeReaderPbPbMC(TTree *tree) : fChain(0) 
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      TDirectory * dir = (TDirectory*)f->Get("/eos/cms/store/group/phys_heavyions/ikucher/bjetFrac/DiJet_pThat-15_TuneCP5_HydjetDrumMB_5p02TeV_Pythia8_PbPbCSVv2TaggersFixed_CleanJets_merged/DiJet_pThat-15_TuneCP5_HydjetDrumMB_5p02TeV_Pythia8_PbPbCSVv2TaggersFixed_merged_part0000_123.root:/hiEvtAnalyzer");
...
hiEvtTreeReaderPbPbMC::~hiEvtTreeReaderPbPbMC()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t hiEvtTreeReaderPbPbMC::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t hiEvtTreeReaderPbPbMC::LoadTree(Long64_t entry)
{
...
void hiEvtTreeReaderPbPbMC::Init(TTree *tree)
{
...
Bool_t hiEvtTreeReaderPbPbMC::Notify()
{
...
void hiEvtTreeReaderPbPbMC::Show(Long64_t entry)
{
...
Int_t hiEvtTreeReaderPbPbMC::Cut(Long64_t entry)
{
...
#endif // #ifdef hiEvtTreeReaderPbPbMC_cxx
