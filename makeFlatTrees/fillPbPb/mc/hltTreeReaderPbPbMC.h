...
// Tue Feb  4 13:35:28 2020 by ROOT version 6.18/04
// from TTree HltTree/
...
#ifndef hltTreeReaderPbPbMC_h
#define hltTreeReaderPbPbMC_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   hltTreeReaderPbPbMC(TTree *tree=0);
   virtual ~hltTreeReaderPbPbMC();
...
#ifdef hltTreeReaderPbPbMC_cxx
hltTreeReaderPbPbMC::hltTreeReaderPbPbMC(TTree *tree) : fChain(0) 
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      TDirectory * dir = (TDirectory*)f->Get("/eos/cms/store/group/phys_heavyions/ikucher/bjetFrac/DiJet_pThat-15_TuneCP5_HydjetDrumMB_5p02TeV_Pythia8_PbPbCSVv2TaggersFixed_CleanJets_merged/DiJet_pThat-15_TuneCP5_HydjetDrumMB_5p02TeV_Pythia8_PbPbCSVv2TaggersFixed_merged_part0000_123.root:/hltanalysis");
...
hltTreeReaderPbPbMC::~hltTreeReaderPbPbMC()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t hltTreeReaderPbPbMC::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t hltTreeReaderPbPbMC::LoadTree(Long64_t entry)
{
...
void hltTreeReaderPbPbMC::Init(TTree *tree)
{
...
Bool_t hltTreeReaderPbPbMC::Notify()
{
...
void hltTreeReaderPbPbMC::Show(Long64_t entry)
{
...
Int_t hltTreeReaderPbPbMC::Cut(Long64_t entry)
{
...
#endif // #ifdef hltTreeReaderPbPbMC_cxx
