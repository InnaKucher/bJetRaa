...
void fillTree_CSV_MC() {
  ...
  TFile *fout = new TFile("/eos/cms/store/group/phys_heavyions/ikucher/bjetFrac/compact_ntuples/jetTree_CSVv2_PbPb_MC_V2.root","RECREATE");
  ...
  */
  ...
  //TagVarCSV_trackSip3dSig_0 / 1/2/3/
  //TagVarCSV_trackSip3dSigAboveCharm 
  //TagVarCSV_trackPtRel_0 / 1/2/3/
  //TagVarCSV_trackEtaRel_0 / 1/2/3/
  //TagVarCSV_trackDeltaR_0 / 1/2/3/
  //TagVarCSV_trackPtRatio_0 / 1/2/3/
  //TagVarCSV_trackJetDist_0 / 1/2/3/
  //TagVarCSV_trackDecayLenVal_0 / 1/2/3/
  ...
  for (Long64_t jentry=0; jentry<nentries;jentry++) {
    ...
    for(int iJet = 0; iJet < nref; iJet++){
      ...
      //cout << "jetR.Jet_nLastTrkTagVarCSV[iJet] = " << jetR.Jet_nLastTrkTagVarCSV[iJet] << endl;
	...
	/*
	cout << "iTrk = " << iTrk << endl;
	cout << "jetR.TagVarCSV_trackSip2dSig[iTrk] = " << jetR.TagVarCSV_trackSip2dSig[iTrk] << endl;
	cout << "jetR.TagVarCSV_trackSip3dSig[iTrk] = " << jetR.TagVarCSV_trackSip3dSig[iTrk] << endl;
	cout << "jetR.TagVarCSV_trackPtRel[iTrk] = " << jetR.TagVarCSV_trackPtRel[iTrk] << endl;
	cout << "jetR.TagVarCSV_trackDeltaR[iTrk] = " << jetR.TagVarCSV_trackDeltaR[iTrk] << endl;
	cout << "jetR.TagVarCSV_trackPtRatio[iTrk] = " << jetR.TagVarCSV_trackPtRatio[iTrk] << endl;
	cout << "jetR.TagVarCSV_trackJetDistVal[iTrk] = " << jetR.TagVarCSV_trackJetDistVal[iTrk] << endl;
	cout << "jetR.TagVarCSV_trackDecayLenVal[iTrk] = " << jetR.TagVarCSV_trackDecayLenVal[iTrk] << endl;
	*/
	...
	//cout << "fabs(jetR.TagVarCSV_trackEtaRel[iTrk]) = " << fabs(jetR.TagVarCSV_trackEtaRel[iTrk]) << endl;
      }
      ...
      /*
      cout << "inumTracks = " << inumTracks << endl;
      cout << "inumEtaRelTracks = " << inumEtaRelTracks << endl;
      */
