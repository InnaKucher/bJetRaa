...
// Mon Mar 16 10:40:03 2020 by ROOT version 6.18/04
// from TTree t/ Jet Analysis Tree
// found on file: /eos/cms/store/group/phys_heavyions/ikucher/bjetFrac/DiJet_pThat-15_TuneCP5_HydjetDrumMB_5p02TeV_Pythia8_MuEnriched_Filter_isGSP_merged/DiJet_pThat-15_TuneCP5_HydjetDrumMB_5p02TeV_Pythia8_MuEnriched_Filter_isGSP_part0.root
//////////////////////////////////////////////////////////

#ifndef jetTreeReaderPbPbMCGSP_h
#define jetTreeReaderPbPbMCGSP_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Float_t         TagVarCSV_trackEtaRel[1000];   //[nTrkTagVarCSV]
   ...
   Int_t           ngen;
   Int_t           genmatchindex[110];   //[ngen]
   Float_t         genpt[110];   //[ngen]
   Float_t         geneta[110];   //[ngen]
   Float_t         geny[110];   //[ngen]
   Float_t         genphi[110];   //[ngen]
   Float_t         genm[110];   //[ngen]
   ...
   jetTreeReaderPbPbMCGSP(TTree *tree=0);
   virtual ~jetTreeReaderPbPbMCGSP();
...
#ifdef jetTreeReaderPbPbMCGSP_cxx
jetTreeReaderPbPbMCGSP::jetTreeReaderPbPbMCGSP(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/eos/cms/store/group/phys_heavyions/ikucher/bjetFrac/DiJet_pThat-15_TuneCP5_HydjetDrumMB_5p02TeV_Pythia8_MuEnriched_Filter_isGSP_merged/DiJet_pThat-15_TuneCP5_HydjetDrumMB_5p02TeV_Pythia8_MuEnriched_Filter_isGSP_part0.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/eos/cms/store/group/phys_heavyions/ikucher/bjetFrac/DiJet_pThat-15_TuneCP5_HydjetDrumMB_5p02TeV_Pythia8_MuEnriched_Filter_isGSP_merged/DiJet_pThat-15_TuneCP5_HydjetDrumMB_5p02TeV_Pythia8_MuEnriched_Filter_isGSP_part0.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("/eos/cms/store/group/phys_heavyions/ikucher/bjetFrac/DiJet_pThat-15_TuneCP5_HydjetDrumMB_5p02TeV_Pythia8_MuEnriched_Filter_isGSP_merged/DiJet_pThat-15_TuneCP5_HydjetDrumMB_5p02TeV_Pythia8_MuEnriched_Filter_isGSP_part0.root:/akFlowPuCs4PFJetAnalyzer");
...
jetTreeReaderPbPbMCGSP::~jetTreeReaderPbPbMCGSP()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t jetTreeReaderPbPbMCGSP::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t jetTreeReaderPbPbMCGSP::LoadTree(Long64_t entry)
{
...
void jetTreeReaderPbPbMCGSP::Init(TTree *tree)
{
...
Bool_t jetTreeReaderPbPbMCGSP::Notify()
{
...
void jetTreeReaderPbPbMCGSP::Show(Long64_t entry)
{
...
Int_t jetTreeReaderPbPbMCGSP::Cut(Long64_t entry)
{
...
#endif // #ifdef jetTreeReaderPbPbMCGSP_cxx
