...
// Tue Feb  4 13:35:59 2020 by ROOT version 6.18/04
// from TTree HltTree/
...
#ifndef globalTreeReaderPbPbMC_h
#define globalTreeReaderPbPbMC_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   globalTreeReaderPbPbMC(TTree *tree=0);
   virtual ~globalTreeReaderPbPbMC();
...
#ifdef globalTreeReaderPbPbMC_cxx
globalTreeReaderPbPbMC::globalTreeReaderPbPbMC(TTree *tree) : fChain(0) 
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      TDirectory * dir = (TDirectory*)f->Get("/eos/cms/store/group/phys_heavyions/ikucher/bjetFrac/DiJet_pThat-15_TuneCP5_HydjetDrumMB_5p02TeV_Pythia8_PbPbCSVv2TaggersFixed_CleanJets_merged/DiJet_pThat-15_TuneCP5_HydjetDrumMB_5p02TeV_Pythia8_PbPbCSVv2TaggersFixed_merged_part0000_123.root:/skimanalysis");
...
globalTreeReaderPbPbMC::~globalTreeReaderPbPbMC()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t globalTreeReaderPbPbMC::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t globalTreeReaderPbPbMC::LoadTree(Long64_t entry)
{
...
void globalTreeReaderPbPbMC::Init(TTree *tree)
{
...
Bool_t globalTreeReaderPbPbMC::Notify()
{
...
void globalTreeReaderPbPbMC::Show(Long64_t entry)
{
...
Int_t globalTreeReaderPbPbMC::Cut(Long64_t entry)
{
...
#endif // #ifdef globalTreeReaderPbPbMC_cxx
