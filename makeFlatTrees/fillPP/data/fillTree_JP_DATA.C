...
void fillTree_JP_DATA() {
  ...
  myReadFileMC.open("HighEG_MuJetfilter.txt");
  string path_mc = "/eos/cms/store/group/phys_heavyions/ikucher/bjetFrac/HighEGJet_Run2017G-17Nov2017-v2_MuJet_merged/";
  char output_mc[800];
  ...
  TFile *fout = new TFile("/eos/cms/store/group/phys_heavyions/ikucher/bjetFrac/compact_ntuples/jetTree_JP_PP_DATA_HighEG_MuonJetsOnly.root","RECREATE");
