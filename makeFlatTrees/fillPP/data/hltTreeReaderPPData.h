...
// Wed Feb 19 10:43:36 2020 by ROOT version 6.18/04
// from TTree HltTree/
...
#ifndef hltTreeReaderPPData_h
#define hltTreeReaderPPData_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   hltTreeReaderPPData(TTree *tree=0);
   virtual ~hltTreeReaderPPData();
...
#ifdef hltTreeReaderPPData_cxx
hltTreeReaderPPData::hltTreeReaderPPData(TTree *tree) : fChain(0) 
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      TDirectory * dir = (TDirectory*)f->Get("/eos/cms/store/group/phys_heavyions/ikucher/bjetFrac/HighEGJet_Run2017G-17Nov2017-v2_MuJet_merged/HighEGJet_Run2017G-17Nov2017-v2_MuJet_part0_9.root:/hltanalysis");
...
hltTreeReaderPPData::~hltTreeReaderPPData()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t hltTreeReaderPPData::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t hltTreeReaderPPData::LoadTree(Long64_t entry)
{
...
void hltTreeReaderPPData::Init(TTree *tree)
{
...
Bool_t hltTreeReaderPPData::Notify()
{
...
void hltTreeReaderPPData::Show(Long64_t entry)
{
...
Int_t hltTreeReaderPPData::Cut(Long64_t entry)
{
...
#endif // #ifdef hltTreeReaderPPData_cxx
