...
// Wed Feb 19 10:44:42 2020 by ROOT version 6.18/04
// from TTree HiTree/
...
#ifndef hiEvtTreeReaderPPData_h
#define hiEvtTreeReaderPPData_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   hiEvtTreeReaderPPData(TTree *tree=0);
   virtual ~hiEvtTreeReaderPPData();
...
#ifdef hiEvtTreeReaderPPData_cxx
hiEvtTreeReaderPPData::hiEvtTreeReaderPPData(TTree *tree) : fChain(0) 
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      TDirectory * dir = (TDirectory*)f->Get("/eos/cms/store/group/phys_heavyions/ikucher/bjetFrac/HighEGJet_Run2017G-17Nov2017-v2_MuJet_merged/HighEGJet_Run2017G-17Nov2017-v2_MuJet_part0_9.root:/hiEvtAnalyzer");
...
hiEvtTreeReaderPPData::~hiEvtTreeReaderPPData()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t hiEvtTreeReaderPPData::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t hiEvtTreeReaderPPData::LoadTree(Long64_t entry)
{
...
void hiEvtTreeReaderPPData::Init(TTree *tree)
{
...
Bool_t hiEvtTreeReaderPPData::Notify()
{
...
void hiEvtTreeReaderPPData::Show(Long64_t entry)
{
...
Int_t hiEvtTreeReaderPPData::Cut(Long64_t entry)
{
...
#endif // #ifdef hiEvtTreeReaderPPData_cxx
