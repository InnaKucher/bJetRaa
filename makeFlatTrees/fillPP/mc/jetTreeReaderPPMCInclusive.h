...
// Mon Feb 24 10:22:17 2020 by ROOT version 6.18/04
// from TTree t/ak4PFpatJetsWithBtagging Jet Analysis Tree
// found on file: /eos/cms/store/group/phys_heavyions/ikucher/bjetFrac/QCD_pThat-15_Dijet_TuneCP5_5p02TeV_pythia8_ppRef5TeV_merged/QCD_pThat-15_Dijet_TuneCP5_5p02TeV_pythia8_ppRef5TeV_part1.root
//////////////////////////////////////////////////////////

#ifndef jetTreeReaderPPMCInclusive_h
#define jetTreeReaderPPMCInclusive_h
...
class jetTreeReaderPPMCInclusive {
public :
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   jetTreeReaderPPMCInclusive(TTree *tree=0);
   virtual ~jetTreeReaderPPMCInclusive();
...
#ifdef jetTreeReaderPPMCInclusive_cxx
jetTreeReaderPPMCInclusive::jetTreeReaderPPMCInclusive(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/eos/cms/store/group/phys_heavyions/ikucher/bjetFrac/QCD_pThat-15_Dijet_TuneCP5_5p02TeV_pythia8_ppRef5TeV_merged/QCD_pThat-15_Dijet_TuneCP5_5p02TeV_pythia8_ppRef5TeV_part1.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/eos/cms/store/group/phys_heavyions/ikucher/bjetFrac/QCD_pThat-15_Dijet_TuneCP5_5p02TeV_pythia8_ppRef5TeV_merged/QCD_pThat-15_Dijet_TuneCP5_5p02TeV_pythia8_ppRef5TeV_part1.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("/eos/cms/store/group/phys_heavyions/ikucher/bjetFrac/QCD_pThat-15_Dijet_TuneCP5_5p02TeV_pythia8_ppRef5TeV_merged/QCD_pThat-15_Dijet_TuneCP5_5p02TeV_pythia8_ppRef5TeV_part1.root:/ak4PFJetAnalyzer");
...
jetTreeReaderPPMCInclusive::~jetTreeReaderPPMCInclusive()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t jetTreeReaderPPMCInclusive::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t jetTreeReaderPPMCInclusive::LoadTree(Long64_t entry)
{
...
void jetTreeReaderPPMCInclusive::Init(TTree *tree)
{
...
Bool_t jetTreeReaderPPMCInclusive::Notify()
{
...
void jetTreeReaderPPMCInclusive::Show(Long64_t entry)
{
...
Int_t jetTreeReaderPPMCInclusive::Cut(Long64_t entry)
{
...
#endif // #ifdef jetTreeReaderPPMCInclusive_cxx
