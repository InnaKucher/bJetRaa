...
void fillTree_JP_MC() {
  ...
  myReadFileMC.open("DiJet_JetFilter.txt");
  string path_mc = "/eos/cms/store/group/phys_heavyions/ikucher/bjetFrac/QCD_pThat-15_Dijet_TuneCP5_5p02TeV_pythia8_ppRef5TeV_merged/";
  char output_mc[800];
  ...
  TFile *fout = new TFile("/eos/cms/store/group/phys_heavyions/ikucher/bjetFrac/compact_ntuples/jetTree_JP_PP_MC_JetFilter.root","RECREATE");
