...
// Wed Feb 19 10:17:01 2020 by ROOT version 6.18/04
// from TTree HiTree/
...
#ifndef hiEvtTreeReaderPPMC_h
#define hiEvtTreeReaderPPMC_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
 ...
 //pair<float,float> *pdfXpdf;
   ...
   hiEvtTreeReaderPPMC(TTree *tree=0);
   virtual ~hiEvtTreeReaderPPMC();
...
#ifdef hiEvtTreeReaderPPMC_cxx
hiEvtTreeReaderPPMC::hiEvtTreeReaderPPMC(TTree *tree) : fChain(0) 
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      TDirectory * dir = (TDirectory*)f->Get("QCD_pThat-15_Dijet_TuneCP5_5p02TeV_pythia8_ppRef5TeV_MuJet_merged/QCD_pThat-15_Dijet_TuneCP5_5p02TeV_pythia8_ppRef5TeV_MuJet_merged.root:/hiEvtAnalyzer");
...
hiEvtTreeReaderPPMC::~hiEvtTreeReaderPPMC()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t hiEvtTreeReaderPPMC::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t hiEvtTreeReaderPPMC::LoadTree(Long64_t entry)
{
...
void hiEvtTreeReaderPPMC::Init(TTree *tree)
{
...
Bool_t hiEvtTreeReaderPPMC::Notify()
{
...
void hiEvtTreeReaderPPMC::Show(Long64_t entry)
{
...
Int_t hiEvtTreeReaderPPMC::Cut(Long64_t entry)
{
...
#endif // #ifdef hiEvtTreeReaderPPMC_cxx
